...
# -*- coding: utf-8 -*-
"""
Script để thêm bảng lesson_youtube_urls hỗ trợ nhiều YouTube URL cho mỗi bài học
"""
import os
import sys
...
def execute_sql(connection_string: str, sql_content: str):
    ...
    print("=" * 60)
    print("🎥 THÊM BẢNG LESSON_YOUTUBE_URLS")
    print("=" * 60)
    ...
    try:
        ...
        if error_count == 0:
            print("\n🎉 Hoàn thành! Bảng lesson_youtube_urls đã được tạo!")
            print("🎯 Giờ bạn có thể gắn nhiều YouTube URL cho mỗi bài học!")
        else:
...
def main():
    ...
    try:
        # Đọc SQL file
        sql_file = "add_multiple_youtube_urls.sql"
