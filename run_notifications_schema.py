...
# -*- coding: utf-8 -*-
"""
Script để tự động chạy notifications table schema trên Supabase
"""
import os
import sys
...
def execute_sql(connection_string: str, sql_content: str):
    ...
    print("=" * 60)
    print("🚀 ĐANG CHẠY NOTIFICATIONS SCHEMA TRÊN SUPABASE")
    print("=" * 60)
    ...
    try:
        ...
        if error_count == 0:
            print("\n🎉 Hoàn thành! Bảng notifications đã được tạo thành công trên Supabase!")
        else:
