...
export default function StudentNotificationsPage() {
    ...
    }, [notifications, searchQuery, filterRead, filterPriority]);
            ...
            <div className="flex min-h-screen">
                ...
                <div className={`flex-1 min-h-screen flex flex-col p-4 lg:p-6 overflow-y-auto transition-all duration-300 ml-0 ${isCollapsed ? 'lg:ml-16' : 'lg:ml-64'}`}>
                    <div className="flex-1 flex flex-col overflow-y-auto">
                        {/* Header */}
                        <div className="mb-8">
                            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-4 lg:p-6 text-white shadow-lg mb-4 lg:mb-6">
                                <h1 className="text-2xl lg:text-4xl font-bold mb-2">Thông báo của tôi</h1>
                                <p className="text-blue-100 text-sm lg:text-lg">Xem và quản lý thông báo nhận được</p>
                            </div>
                        </div>
                                ...
                                {filteredNotifications.length === 0 ? (
                                    <div className="text-center py-12">
                                        ...
                                        <p className="text-gray-500 text-sm mt-2">
                                            {searchQuery || filterRead !== 'all' || filterPriority !== 'all'
                                                                ...
                                                                <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500">
                                                                    {notification.teacher_name && (
                                                                        <div className="flex items-center gap-1">
                                                                            ...
                                                                            <span>Từ: {notification.teacher_name}</span>
                                                                        </div>
                                                                    )}
