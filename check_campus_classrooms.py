...
Kiểm tra dữ liệu cơ sở và lớp học trong database
"""
...
def check_schedule_page_logic():
    """Check the schedule page logic"""
    print("📋 SCHEDULE PAGE LOGIC CHECK")
    print("=" * 50)
    
    print("Frontend logic should:")
    print("1. Load all campuses")
    print("2. When campus is selected, filter classrooms by campus_id")
    print("3. Display classrooms in dropdown")
    print()
    print("API endpoint used: GET /api/classrooms?campus_id={campus_id}")
    print("Backend should filter: WHERE classrooms.campus_id = {campus_id}")
...
def main():
    ...
    # Check schedule page logic
    print("\n" + "=" * 60)
    check_schedule_page_logic()
